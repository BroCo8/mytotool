...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Modifier {{ $todo->title }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('todo.update', $todo->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            @enderror" name="title" value="{{ $todo->title }}" required autocomplete="title" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control @error('password') is-invalid 
                            @enderror" autocomplete="description" value="{{ $todo->description }}">{{ $todo->description }}</textarea>
